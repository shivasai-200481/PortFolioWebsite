    ...
    return (
        <section name='Projects' className="bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100 py-16">
            <div className="max-w-screen-2xl px-4 md:px-20 container mx-auto">
                <h2 className="text-4xl font-bold text-center mb-12 text-gray-800 drop-shadow-md">
                    🚀 Projects
                </h2>
                ...
                <div className="grid gap-10 md:grid-cols-2">
                    {projects.map((project, index) => (
                        <a
                            ...
                            className="p-6 rounded-2xl shadow-xl bg-white/60 backdrop-blur-md border border-white/30 hover:scale-105 hover:shadow-2xl transition-transform duration-300"
                        >
